...
#interested in seeing how nonwhite voters voted in the elections specifically the average mean for the democratic candidates in Florida. 
...
#looking at immigrant voting paterns in Florida specifically 
inner_join(counties_elexresults, counties_demographics) %>% 
  filter(state_code == "FL") %>% 
